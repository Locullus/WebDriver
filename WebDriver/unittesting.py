...
class TestChromedriver(unittest.TestCase):
    ...
    def test_isfile(self):
        self.assertTrue(os.path.isfile('chromedriver2/chromedriver.exe'))         # true
        self.assertFalse(os.path.isfile('chromedriver.zip'))        # false
        self.assertTrue(os.path.isfile('chromedriver2/chromedriver_version'))     # True
    ...
    def test_chromedriver_version_file(self):
        self.assertRegex(tools_functions.get_datas('chromedriver2/chromedriver_version'), "\\d{2}")
